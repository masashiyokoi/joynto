...
class TimelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post timelines_url, params: { timeline: { content: @timeline.content, type: @timeline.type } }
    end
  ...
  test "should update timeline" do
    patch timeline_url(@timeline), params: { timeline: { content: @timeline.content, type: @timeline.type } }
